...
struct rect
{
    ...
    rect adjust_ratio(float20 size) const
    {
...
#include "/home/group05/Desktop/RealSense/librealsense/third-party/stb_easy_font.h"
...
private:
    ...
    float20 xyz_to_xy(float x, float y, float z, GLfloat model[], GLfloat proj[], float vec_norm)
    {
    ...
    static void draw_circle(float xx, float xy, float xz, float yx, float yy, float yz, float radius = 1.1, float10 center = { 0.0, 0.0, 0.0 }, float intensity = 0.5f)
    {
        const auto N = 50;
